/**
 * E2E test that verifies codestack can read and use knowledge.md from the project.
 *
 * Starts codestack in tmux, creates a knowledge.md file with a unique keyword,
 * asks codestack about that keyword, and verifies it responds using the knowledge.
 *
...
describe('codestack: Knowledge Files', () => {
