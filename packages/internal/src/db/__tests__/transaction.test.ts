...
describe('withSerializableTransaction', () => {
  ...
  // Note: Analytics event tracking was removed along with PostHog integration.
  // The transaction retry logic remains unchanged, but event emission is no longer tested.
